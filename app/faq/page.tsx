  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <header className="sticky top-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 py-3 sm:py-5 flex justify-between items-center gap-4 sm:gap-6">
          <Link href="/" className="flex items-center gap-1.5 sm:gap-4 animate-slide-in hover:opacity-80 transition-opacity">
            ...
            <div className="min-w-0">
              <h1 className="text-[9px] sm:text-lg lg:text-2xl font-black tracking-tight text-blue-500 whitespace-nowrap">
                Fighter Card
              </h1>
              <p className="hidden sm:block text-xs text-gray-400 font-medium">Cartes de Combat Personnalisées</p>
            </div>
          </Link>
          <Link
            href="/"
            className="btn-outline text-xs sm:text-sm px-3 py-2 sm:px-5 sm:py-2.5 flex-shrink-0"
          >
            Retour
          </Link>
        </div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#0a0a0a] min-h-[calc(100vh-100px)]">
        <div className="max-w-7xl mx-auto">
          <SmoothReveal direction="up" delay={0.1}>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600/10 border border-blue-600/30 rounded-full mb-6">
                <span className="text-sm font-bold text-blue-400 tracking-wide uppercase">Aide & Support</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-black tracking-tight mb-6">
                Questions <span className="text-blue-500">Fréquentes</span>
              </h1>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                Tout ce que tu dois savoir sur Fighter Card
              </p>
            </div>
          </SmoothReveal>
          ...
          {/* Comment ça marche - Après les Questions Fréquentes */}
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16 px-4">
              ...
              <div className="relative group">
                ...
                <div className="relative premium-card p-4 sm:p-6 md:p-8 text-center overflow-hidden">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-xl xl:text-xl font-bold leading-tight mb-4 break-words px-2">
                    Personnalise
                  </h3>
              ...
              <div className="relative group">
                ...
                <div className="relative premium-card p-4 sm:p-6 md:p-8 text-center overflow-hidden">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-xl xl:text-2xl font-bold leading-tight mb-4 break-words px-2">
                    Choisis un Template
                  </h3>
                  <p className="text-sm sm:text-base text-gray-400 leading-relaxed break-words px-2">
